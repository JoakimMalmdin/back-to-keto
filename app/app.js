...
const foodSignals = [
  ...
  { match: /(?:benfria?\s*)?fläskkotlett(?:er)?|(?:benfria?\s*)?flaskkotlett(?:er)?/i, kcal: 256, protein: 33.8, fat: 13.8, carbs: 0, servingGrams: 125, keto: 1 },
...
function signalLabel(signal) {
  ...
  const labels = [
    ...
    [/fläskkotlett|flaskkotlett/, "Benfri fläskkotlett"],
