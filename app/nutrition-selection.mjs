...
export const NUTRITION_SELECTION = Object.freeze([
  ...
  labelled("saeby-makrill-tomatsas", "Dansk makrillfilé i tomatsås (Sæby)", "Danish mackerel fillet in tomato sauce (Sæby)", "seafood", 1, SELECTION_STATUSES.inCatalogue, "saeby-makrill-tomatsas"),
  ...
  labelled("lidl-tonfisk-i-vatten", "Lidl tonfisk i vatten", "Lidl tuna in water", "seafood", 1, SELECTION_STATUSES.inCatalogue, "lidl-tonfisk-i-vatten"),
  ...
  proxy("vassleisolat", "Vassleisolat", "Whey isolate", "supplements", 2, "vassleisolat", "Generisk vassleisolatpost; 1 skopa räknas som 30 g tills produktetikett verifieras."),
  ...
  proxy("flankstek", "Flankstek", "Flank steak", "meat", 1, "flankstek", "Mager nötköttsschablon tills bättre verifierad källa eller etikett finns."),
  ...
  labelled("creme-fraiche-32", "Crème fraiche 32%", "Creme fraiche 32%", "dairy", 2, SELECTION_STATUSES.inCatalogue, "creme-fraiche-32"),
  ...
  slvPromoted("kaffe", "Kaffe bryggt", "Brewed coffee", "drinks", 2, "Kaffe bryggt", "Analyserad LD-post; i appen räknas en kopp som 200 ml."),
  ...
  labelled("frenchs-yellow-mustard", "French's Yellow Mustard", "French's Yellow Mustard", "seasonings", 3, SELECTION_STATUSES.inCatalogue, "frenchs-yellow-mustard"),
  labelled("lindt-mork-choklad-85", "Lindt mörk choklad 85%", "Lindt dark chocolate 85%", "seasonings", 3, SELECTION_STATUSES.inCatalogue, "lindt-mork-choklad-85"),
